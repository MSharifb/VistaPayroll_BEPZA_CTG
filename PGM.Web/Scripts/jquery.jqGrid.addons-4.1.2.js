            ...
            return this.each(function () {
                ...
                var formFill = function () {
                    ...
                    if (self.p.enableSearch === true) {
                        ...
                        sb = "<div class='buttonSubmit'><span></span><input type='button' id='sButton' class='" + self.p.buttonclass + "' value='" + self.p.searchButton + "'/></div>";
                        $(td).append(sb);
                    ...
                    if (self.p.enableClear === true) {
                        ...
                        cb = "<div class='buttonSubmit'>&nbsp;</div><div class='buttonSubmit'><span></span><input type='button' id='cButton' class='" + self.p.buttonclass + "' value='" + self.p.clearButton + "'/></div>";
                        $(td).append(cb);
