<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports/RptCommon/MasterPage/ReportMaster.Master"
    CodeBehind="SalaryPaySlip.aspx.cs" Inherits="PGM.Web.Reports.PGM.viewers.SalaryPaySlip" %>
            ...
            <fieldset>
                ...
                <div class="GroupBox">
                    ...
                    <div class="row">
                        ...
                        <span class="field">
                            <asp:DropDownList runat="server" ID="ddlEmpCategory" CssClass="form-control select-single">
                            </asp:DropDownList>
                        </span>
                        <span class="label-right">
                    ...
                    <div class="row">
                        ...
                        <span class="field">
                            <asp:DropDownList runat="server" ID="ddlSelectEmployeeType" CssClass="form-control select-single">
                            </asp:DropDownList>
                        </span>
                    </div>
                    <div class="row">
