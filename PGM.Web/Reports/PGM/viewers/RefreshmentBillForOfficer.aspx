<%@ Page Title=""
    ...
    CodeBehind="RefreshmentBillForOfficer.aspx.cs"
    Inherits="PGM.Web.Reports.PGM.viewers.RefreshmentBillForOfficer" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <fieldset>
                ...
                <div>
                    <rsweb:ReportViewer ID="rvRefreshmentBillForOfficer" runat="server" Width="100%" Visible="true"
                        Height="100%" OnReportRefresh="rvRefreshmentBillForOfficer_ReportRefresh">
                    </rsweb:ReportViewer>
                    <div class="clear">
                    </div>
                </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="rvRefreshmentBillForOfficer" />
