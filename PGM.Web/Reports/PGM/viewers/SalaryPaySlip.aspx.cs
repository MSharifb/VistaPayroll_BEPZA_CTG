...
{
    public partial class SalaryPaySlip : PGMReportBase
    {
        #region Properties
        ...
        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (data.Count > 0)
                {
                    ...
                    {
                        ToEmailAddress = _pgmExecuteFunctions.GetEmployeeById(Convert.ToInt32(emp.EmployeeId))?.EmialAddress;
                        CCEmailAddress = "";
                        ...
                        {
                            string body = CreateBody(emp);

                            var email = new EmailProcessor();
        ...
        private string CreateBody(DAL.PGM.sp_PGM_Payslip_Result item)
        {
            ...
            try
            {
                ...
                if (item != null)
                {
                    ...
                    //String salaryHeadGroupNameStart = ""; String salaryHeadGroupNameEnd = "";
        ...
        private void GenerateReport(string selectedYear, string selectedMonth, int designationId, int empTypeId, int employeeId, int jobGradeId, int categoryId, String zoneList)
        {
            try
            {
                ...
                else
                {
                    ...
                    rvSalaryPaySlipRpt.LocalReport.ReportPath = Server.MapPath("~/Reports/PGM/rdlc/SalaryPaySlipRpt.rdlc");
                    ...
                    //ExportToPDF
                    String fileName = "PaySlip_" + Guid.NewGuid() + ".pdf";
            ...
            try
            {
                ...
                switch (e.ReportPath)
                {
                    ...
                    case "_SalaryPaySlipDetailAddition":
                        ...
                        var dataAddition = (from ad in base._pgmContext.GetSalaryPaySlipDetailAddition(EmpID, selectedYear, selectedMonth, numErrorCode, strErrorMsg) select ad).OrderBy(x => x.SortPriority).ToList();
                    ...
                    case "_SalaryPaySlipDetailDeduction":
                        ...
                        var dataDeduction = (from ad in base._pgmContext.GetSalaryPaySlipDetailDeduction(EmpID, selectedYear, selectedMonth, numErrorCode, strErrorMsg) select ad).OrderBy(x => x.SortPriority).ToList();
