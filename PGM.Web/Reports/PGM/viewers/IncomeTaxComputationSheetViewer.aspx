<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Reports/RptCommon/MasterPage/ReportMaster.Master"
    CodeBehind="IncomeTaxComputationSheetViewer.aspx.cs" Inherits="PGM.Web.Reports.PGM.viewers.IncomeTaxComputationSheetViewer" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="GroupBox" style="width: 98%; margin: 10px auto;">
                <rsweb:ReportViewer ID="rvIncomeTaxComputationRpt" runat="server" Width="100%" Height="100%"
