<%@ Page Title=""
    ...
    CodeBehind="AttendanceRpt.aspx.cs"
    Inherits="PGM.Web.Reports.PGM.viewers.AttendanceRpt" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <fieldset>
                ...
                <div>
                    <rsweb:ReportViewer ID="rvAttendance" runat="server" Width="100%" Visible="true"
                        Height="100%" OnReportRefresh="rvAttendance_ReportRefresh">
                    </rsweb:ReportViewer>
                    <div class="clear">
                    </div>
                </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="rvAttendance" />
