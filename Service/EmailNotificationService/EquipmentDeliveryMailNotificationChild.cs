...
{
  public class EquipmentDeliveryMailNotificationChild: LogFilesWritting
    {
       ...
       public string tableHeaderBackgroundColor;
        ...
        public EquipmentDeliveryMailNotificationChild()
        {
            try
            {
        ...
        /// <summary>
        /// Equipment Delivery email notification. Project wise mail body creation by using this method for each project. 
        /// Using SP is SP_PIM_SendEmailForEquipmentDelivery
        /// </summary>
        ...
        public string CreateBody(int ProjectId, int NoOfAfterMonthsConsider)
        {
            ...
            try
            {
                ...
                if (dsResult.Tables[0].Rows.Count > 0)
                {
                    ...
                    content += "<th style='border-collapse:collapse;border:" + tableBorderColor + ";'>Equipment Name</th>";
                    content += "<th style='border-collapse:collapse;border:" + tableBorderColor + ";'>Quantity</th>";
                    content += "<th style='border-collapse:collapse;border:" + tableBorderColor + ";'>Delivery Date</th>";
                    ...
                    foreach (DataRow dr in dsResult.Tables[0].Rows)
                    {
                        ...
                        var EquipmentName = dr["EquipmentName"];
                        var Quantity = dr["Quantity"];
                        var DateofDelivery = Convert.ToDateTime(dr["DateofDelivery"]).ToString("dd-MMM-yyyy");
                        ...
                        content += EquipmentName + "</td><td style='border-collapse:collapse;border:" + tableBorderColor + ";text-align:right;'>";
                        content += Quantity + "</td><td style='border-collapse:collapse;border:" + tableBorderColor + ";text-align:center;'>";
                        content += DateofDelivery + "</td></tr>";
