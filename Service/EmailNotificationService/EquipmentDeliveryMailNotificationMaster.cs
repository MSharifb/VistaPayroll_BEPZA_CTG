...
{
    public class EquipmentDeliveryMailNotificationMaster : LogFilesWritting
    {
        ...
        public EquipmentDeliveryMailNotificationMaster()
        {
            try
            {
                ...
                NoOfAfterMonthsConsider = Convert.ToInt16(navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/NoOfAfterMonthsConsider").Value);
                EmailSendDateInMonthList = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/EmailSendDateInMonth").Value;
                ToEmailAddress = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/ToEmailAddress").Value;
                CCEmailAddress = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/CCEmailAddress").Value;
                BCCEmailAddress = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/BCCEmailAddress").Value;

                Subject = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/Subject").Value;
                Salutation = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/Salutation").Value;
                BodyHeader = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/BodyHeader").Value;
                BodyFooter = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/BodyFooter").Value;
                NoRecordFound = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/NoRecordFound").Value;
                ToEmailPersonName = navigator.SelectSingleNode("//PIMEmailNotification/EquipmentDeliveryEmailNotification/ToEmailPersonName").Value;
        ...
        public void EquipmentDeliveryScheduleMailSending() 
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand("SP_PIM_SendEmailForEquipmentDelivery".Trim(), connection);
                ...
                if (dsResult.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow drItem in dsResult.Tables[0].Rows)
                    {
                        ...
                        EquipmentDeliveryMailNotificationChild tsBodyMST = new EquipmentDeliveryMailNotificationChild();
                        ...
                        {
                            LogInfo("Successful- Equipment Delivery. E-mail sent.");
                        }
                    }
                }
                else
